...
class UserInput(BaseModel):
    age: Annotated[int, Field(..., ge=0, lt=80, description="Age of the user in years")]
 ...
 'unemployed', 'private_job'], Field(..., description="Occupation of the user")]
    
    @field_validator('city')
    @classmethod
    def normalize_city(cls, w:str) -> str:
        w = w.strip().title()
        return w
